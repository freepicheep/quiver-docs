...
If you are new to the tool, continue with [Getting Started](/docs/getting-started). If you need the file formats, go to [Manifest and Lockfile](/docs/manifest-and-lockfile). If you want implementation details, go to [Architecture](/docs/architecture).
